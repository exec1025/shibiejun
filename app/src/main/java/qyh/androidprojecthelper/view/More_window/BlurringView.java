...
public class BlurringView extends View {
    ...
    private static final String TAG = com.ms_square.etsyblur.BlurringView.class.getSimpleName();

    private BlurConfig blurConfig;

    private BlurEngine blur = new NoBlur();
    ...
    public BlurringView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.ms_square.etsyblur.R.styleable.BlurringView);
        int overlayColor = typedArray.getInt(com.ms_square.etsyblur.R.styleable.BlurringView_overlayColor, BlurConfig.DEFAULT_OVERLAY_COLOR);
        int blurRadius = typedArray.getInt(com.ms_square.etsyblur.R.styleable.BlurringView_radius, BlurConfig.DEFAULT_RADIUS);
        int downScaleFactor = typedArray.getInt(com.ms_square.etsyblur.R.styleable.BlurringView_downScaleFactor, BlurConfig.DEFAULT_DOWN_SCALE_FACTOR);
        boolean allowFallback = typedArray.getBoolean(com.ms_square.etsyblur.R.styleable.BlurringView_allowFallback, BlurConfig.DEFAULT_ALLOW_FALLBACK);
        boolean debug = typedArray.getBoolean(com.ms_square.etsyblur.R.styleable.BlurringView_debug, BlurConfig.DEFAULT_DEBUG);
        typedArray.recycle();
