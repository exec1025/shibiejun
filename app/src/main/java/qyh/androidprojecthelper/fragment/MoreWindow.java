...
public class MoreWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void init(View view) {
        ...
        layout = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.more_windows, null);
...
//                                bgView.setVisibility(View.VISIBLE);
    ...
    private void showAnimation(ViewGroup layout) {
        try {
            LinearLayout linearLayout = (LinearLayout) layout.findViewById(R.id.lin);
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    //＋ 旋转动画
            ...
            for (int i = 0; i < linearLayout.getChildCount(); i++) {
                ...
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        KickBackAnimatorUtils kickAnimator = new KickBackAnimatorUtils();
